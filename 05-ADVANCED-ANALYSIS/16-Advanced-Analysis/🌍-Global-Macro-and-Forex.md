...
### **Studi Kasus: Indonesia dalam Ekonomi Global** 🇮🇩
```
...
## 💱 Forex Market Structure and Analysis
...
### **Studi Kasus: Trading IDR dalam Konteks Global** 💱
```
...
1. Interest Rate Differentials:
   ...
   2022: BI Rate 3.75% → 5.75%, Fed 0% → 4.5%
   2023: BI Rate stable 5.75%, Fed 4.5% → 5.5%
...
2. Commodity Prices:
   ...
   - Palm Oil ↑ → Trade surplus ↑ → IDR strength
   - Coal ↑ → Export revenues ↑ → IDR strength
   - Nickel ↑ → Terms of trade ↑ → IDR strength
...
### **Studi Kasus: RCEP dan Indonesia** 🌏
```
...
### **Next**: [[🌍-International-Trade-Dynamics]]
...
*📚 Lanjutkan ke: [[🌍-International-Trade-Dynamics]]*
