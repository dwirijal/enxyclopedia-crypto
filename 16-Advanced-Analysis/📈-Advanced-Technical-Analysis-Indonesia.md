...
## 🎯 Overview Analisis Teknikal Lanjutan
...
├── High Volatility: Beta 1.2-1.5 vs global markets
├── Retail Dominance: 65% trading volume from retail
├── Currency Factor: IDR/USD correlation effects
├── Policy Sensitivity: Government interventions frequent
├── Liquidity Patterns: Intraday volatility spikes
└── Seasonal Trends: Religious and holiday effects
```
...
Outcome Analysis:
- Breakout occurred: Rp 9,800 → Rp 10,600
- Timeframe: 3 weeks
...
XA Retracement: Rp 4,200 → Rp 5,100 = Rp 900
...
Calculation:
VaR (95%) = Portfolio × Volatility × Z-score
VaR (95%) = 1B × 1.8% × 1.65 = Rp 29,700,000
...
*🔗 Related: [[🌍-Global-Macro-and-Forex]] [[🔮-Economic-Indicator-Analysis]] [[📊-Portfolio-Management-Strategies]]*
*📚 Next: [[Quantitative-Finance-Strategies]] [[Behavioral-Finance-Psychology]]*